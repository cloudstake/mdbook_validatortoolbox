...
- [Pre-Installation Information](pre-installation/README.md)
  - [The "validatortoolbox" Way](pre-installation/new-validator-steps/easy-node-way.md)
  - [New Validator Steps](pre-installation/new-validator-steps/README.md)
  - [Server or Server Provider](pre-installation/new-validator-steps/server-or-server-provider.md)
  - [Shard Choice](pre-installation/new-validator-steps/shard-choice.md)
  - [SSH Keys for Login](pre-installation/new-validator-steps/ssh-keys-private-and-public-pair.md)
...
- [Server Prep](server-prep/README.md)
